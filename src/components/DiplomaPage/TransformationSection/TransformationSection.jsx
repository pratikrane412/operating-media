...
const OUTCOMES = [
    {
        ...
        desc: 'Learn the core tools that every digital marketing employer looks for — from day one',
        delay: 0.10,
    },
    {
        iconName: 'trophy',
        title: 'Live Campaign Practice',
        desc: 'Run actual Google and Meta ad campaigns with real budgets during the course',
        delay: 0.18,
    },
    {
        iconName: 'sparkles',
        title: '50+ Premium Tools',
        desc: 'Hands-on access to industry-leading tools used by top agencies and brands',
        delay: 0.26,
    },
    {
        iconName: 'star',
        title: 'Placement Support',
        desc: '200+ hiring partners across agencies, brands and startups — ready to hire you',
        delay: 0.34,
    },
];
...
const CHECKLIST = [
    'Hands-on with 50+ premium tools',
                ...
                <div className="grid lg:grid-cols-[1fr_450px] gap-12 lg:gap-16 items-start">
                    ...
                    <div>
                        ...
                        <motion.p initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.14 }} className="text-[16px] md:text-[18px] font-medium text-gray-600 max-w-[500px] mb-10 leading-relaxed">
                            ...
                            <span className="font-bold text-[#0f172a]">hands-on, execution-first program</span>. You&apos;ll master SEO, Google Ads &amp; Social Media — and be interview-ready before you graduate.
                        </motion.p>
                    ...
                    <div className="lg:sticky lg:top-24 self-start relative z-20">
                        <motion.div initial={{ opacity: 0, y: 32 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.12 }} className="relative bg-white rounded-[2rem] overflow-hidden border border-gray-200 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)]">
                            ...
                            <div className="bg-[#0f172a] px-8 pt-8 pb-6 relative overflow-hidden">
                                ...
                                <p className="text-[15px] font-medium text-gray-400 mt-2 relative z-10">Limited to 10 seats per batch.</p>
                            ...
                            <div className="px-6 pb-8">
                                <button onClick={() => setIsModalOpen(true)} className="group w-full flex items-center justify-center gap-3 py-4 rounded-xl cursor-pointer bg-[#ECAB00] hover:bg-[#0f172a] text-[#0f172a] hover:text-white text-[16px] font-black shadow-[0_10px_20px_-10px_rgba(236,171,0,0.5)] hover:shadow-2xl transition-all duration-300">
