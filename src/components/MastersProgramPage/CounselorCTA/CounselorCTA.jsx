        ...
        <div className="flex flex-col md:flex-row items-center justify-between min-h-[280px] md:min-h-[260px] lg:min-h-[280px] relative">
          ...
          <div className="flex-1 pt-8 pb-4 md:py-5 z-10 text-center md:text-left order-1 md:order-1">
            ...
            >
              {/* Heading */}
              <h2
                className="text-[#212121] font-semibold leading-[1.2] mb-6 tracking-tight"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-white hover:bg-black hover:text-white text-[#212121] font-bold rounded-full transition-all duration-300"
                style={{
