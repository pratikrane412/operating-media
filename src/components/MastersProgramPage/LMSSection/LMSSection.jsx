...
const LMSSection = () => {
  ...
  return (
    <section className="py-8 lg:py-12 bg-[#F8F9FB] font-['Inter'] antialiased overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        
        {/* EDITORIAL HEADER - Reduced bottom margin */}
        <div className="text-center mb-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-[#212121] font-semibold text-[30px] lg:text-[42px] leading-tight mb-3 tracking-tight">
              A Private Ecosystem for <span className="text-[#FF5A1F]">Future Leaders</span>
            </h2>
            <p className="text-[#808080] font-medium text-[15px] lg:text-[17px] max-w-xl mx-auto">
        ...
        <div className="relative flex flex-col items-center">
          ...
          {/* 1. THE NAVIGATION TABS - Tighter padding */}
          <div className="flex flex-wrap justify-center gap-2 mb-8 z-20">
            {features.map((f, i) => (
              <button
                key={i}
                onClick={() => setActive(i)}
                className={`px-5 py-3 rounded-full border transition-all duration-300 flex items-center gap-2 font-semibold text-[13px]
                ${active === i 
          ...
          {/* 2. THE MAIN DESKTOP MOCKUP - Reduced from max-w-5xl to max-w-4xl */}
          <div className="relative w-full max-w-4xl z-10">
            
            {/* Floating Glass Widget: Active Notification - Scaled down */}
            <motion.div 
            ...
            >
              <div className="w-8 h-8 rounded-full bg-[#FF5A1F] flex items-center justify-center text-white shadow-lg shadow-orange-500/30">
                <Bell size={16} />
              </div>
              <div className="text-start">
                <p className="text-black font-black text-[11px]">New Resource</p>
                <p className="text-[9px] text-gray-400 font-bold uppercase">SEO Mastery Guide</p>
              </div>
            </motion.div>

            {/* Floating Glass Widget: Search Bar - Scaled down */}
            <motion.div 
              initial={{ x: 30, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }}
            ...
            >
              ...
              <p className="text-gray-400 text-xs font-medium">Search tools...</p>
              <div className="ml-auto bg-[#FF5A1F] text-white px-2 py-0.5 rounded-full text-[8px] font-black uppercase tracking-wider">Live</div>
            </motion.div>

            {/* Main Application Window - Tightened corners and padding */}
            <motion.div 
            ...
            >
              ...
              <div className="flex items-center justify-between px-8 py-3">
                 ...
                 <div className="text-[9px] font-black text-white/30 uppercase tracking-[0.3em]">OM / PORTAL / 2026</div>
              ...
              <div className="relative aspect-video rounded-[2rem] overflow-hidden bg-black group">
                ...
                {/* Feature Overlay Card - Scaled down padding and text */}
                <div className="absolute top-6 left-6 max-w-[240px] bg-[#FF5A1F]/90 backdrop-blur-xl p-5 rounded-[1.5rem] border border-white/10 text-start shadow-xl">
                   <p className="text-[#F5C518] text-[9px] font-black uppercase tracking-widest mb-1.5 flex items-center gap-2">
                     <Sparkles size={10} /> Featured
                   </p>
                   <h3 className="text-white font-bold text-lg mb-2">{features[active].title}</h3>
                   <p className="text-white/80 text-[12px] leading-relaxed">{features[active].desc}</p>
                </div>
              </div>
            </motion.div>
        ...
        {/* FINAL CONVERSION STRIP - Reduced margin and padding */}
        <div className="mt-8 max-w-3xl mx-auto flex flex-col md:flex-row items-center justify-between p-4 bg-white rounded-[2.5rem] border border-gray-100 shadow-sm">
           <div className="flex items-center gap-4 mb-4 md:mb-0">
              ...
              <div className="text-start">
                 <p className="text-[#212121] font-bold text-lg tracking-tight">Experience it live.</p>
                 <p className="text-[#808080] font-medium text-sm">Schedule a live portal walkthrough.</p>
              </div>
           </div>
           <button className="bg-[#FF5A1F] hover:bg-[#E54D16] text-white font-bold text-[14px] px-8 py-4 rounded-full transition-all flex items-center gap-2 group shadow-lg shadow-orange-500/10">
              Get Free Access <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
           </button>
        </div>
