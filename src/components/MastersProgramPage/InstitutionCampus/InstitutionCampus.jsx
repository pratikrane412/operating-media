  ...
  <div className="flex gap-3 h-[550px] shrink-0 px-1.5">
    ...
    <div className="w-[280px] h-full relative group overflow-hidden rounded-3xl border border-black/5 bg-black">
      ...
      <div className="absolute bottom-6 left-6 z-20">
        <p className="text-white font-poppins font-black text-[10px] tracking-widest uppercase bg-[#FF6B00] px-3 py-1">Events</p>
      </div>
    </div>
    ...
    <div className="w-[580px] grid grid-rows-2 gap-3 h-full">
      <div className="grid grid-cols-12 gap-3">
        <div className="col-span-7 relative group overflow-hidden rounded-3xl border border-black/5">
          ...
          <img src={images[1].url} className="w-full h-full object-cover" alt="Gallery" />
        </div>
        <div className="col-span-5 relative group overflow-hidden rounded-3xl border border-black/5 bg-[#FF6B00]">
          <img src={images[2].url} className="w-full h-full object-cover mix-blend-multiply transition-transform group-hover:scale-110" alt="Gallery" />
        </div>
      </div>
      <div className="grid grid-cols-12 gap-3">
        <div className="col-span-5 relative group overflow-hidden rounded-3xl border border-black/5">
          <img src={images[3].url} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-500" alt="Gallery" />
        </div>
        <div className="col-span-7 relative group overflow-hidden rounded-3xl border border-black/5">
          <img src={images[4].url} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="Gallery" />
    ...
    <div className="w-[280px] h-full relative group overflow-hidden rounded-3xl border border-black/5 shadow-sm">
      <img src={images[5].url} className="w-full h-full object-cover" alt="Gallery" />
      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-8">
        <p className="text-white font-lora italic text-lg leading-tight">"Where education meets celebration."</p>
      </div>
    </div>
  </div>
);
...
const InstitutionCampus = () => {
  ...
  return (
    <section className="bg-white py-10 font-inter antialiased overflow-hidden">
      {/* --- HEADER --- */}
      <div className="max-w-7xl mx-auto px-6 lg:px-12 mb-16 motion-translate-x-in-[11%] motion-translate-y-in-[-14%] motion-duration-[0.71s]/translate motion-delay-[0.04s]/translate">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <h2 className="font-poppins font-black text-black text-4xl lg:text-5xl leading-tight tracking-tighter uppercase">
            Life <span className="font-lora italic font-medium lowercase text-[#FF6B00]"> At </span> Operating Media.
          </h2>
          <p className="max-w-md font-inter text-black/60 text-sm leading-relaxed border-l-2 border-black/10 pl-6">
      ...
      <div className="relative flex overflow-hidden group">
        <motion.div 
          ...
          animate={{ x: ["0%", "-50%"] }} // Moves half the width (one full set of grids)
          transition={{ 
