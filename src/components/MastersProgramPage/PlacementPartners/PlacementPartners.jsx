  ...
  return (
    ...
    >
      {src && !imgFailed ? (
        ...
        <span className="font-inter font-bold text-[9px] text-gray-400
                         uppercase tracking-widest text-center leading-tight">
          {name}
        </span>
      )}
    </motion.div>
...
export default function PlacementPartners() {
  return (
    <section className="py-5 sm:py-8 md:py-8 px-4 bg-[#FAFAF8] font-inter antialiased">
      <div className="max-w-6xl mx-auto">
        ...
        >
          {/* Heading — Yellow scribble removed from here */}
          <div className="inline-block relative mb-4">
            <h2 className="font-inter font-extrabold text-gray-900 tracking-tight
                           text-2xl sm:text-4xl lg:text-[2.8rem]">
              250+ Placement Partners
            </h2>
          </div>

          <p className="font-inter font-normal text-gray-400 text-sm sm:text-base
                        max-w-xl mx-auto leading-relaxed mt-4">
        ...
        >
          ...
          <p className="font-inter font-normal text-gray-400 text-xs sm:text-sm text-center">
            And{" "}
            <span className="font-semibold text-gray-700">100s more</span>{" "}
