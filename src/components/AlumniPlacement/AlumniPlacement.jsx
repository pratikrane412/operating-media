...
const StudentCard = ({ item }) => (
  <div
    ...
    style={{ width: "clamp(175px, 16vw, 215px)", fontFamily: "'Satoshi', sans-serif" }}
  >
    ...
    <div className="px-4 pt-3.5 pb-4 flex flex-col gap-1">
      <h4
        className="text-[14px] font-black text-gray-950 leading-tight tracking-tight"
...
export default function AlumniPlacement() {
  return (
    <section
      className="placement-section bg-white py-5"
      style={{ fontFamily: "'Satoshi', sans-serif" }}
    >
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-10 mb-10">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
          ...
          <div>
            {/* Pre-title */}
            <p
              className="text-[14px] font-semibold text-gray-500 mb-1 tracking-wide"
              style={{ fontFamily: "'Satoshi', sans-serif" }}
            >
              Meet our
            </p>
            ...
            {/* Main title */}
            <h2
              className="font-black text-gray-950 leading-[1.0] tracking-tight"
              style={{
      ...
      {/* overflow-x-hidden on outer clips horizontal bleed; inner is overflow-visible so hover lift isn't cut */}
      ...
      <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 px-6">
        <motion.button
          ...
          className="relative overflow-hidden bg-gray-950 text-white
            px-9 py-3.5 rounded-xl font-bold text-[14px] shadow-lg
