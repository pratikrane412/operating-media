...
import { CheckCircle2, ChevronDown, Download, BarChart2 } from 'lucide-react';
...
const ga4Topics = [
    ...
    "Funnel Exploration & Path Analysis",
...
const modules = [
    {
        ...
        desc: "Learn how to use Google Analytics 4 to track website traffic, user behavior, and performance metrics to make data-driven decisions.",
        topics: ga4Topics,
    },
];
...
export default function GASyllabus() {
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto">
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 border border-amber-100 mb-6">
                        ...
                        <span className="font-bold text-[11px] md:text-xs text-[#ECAB00] uppercase tracking-[0.2em]">Google Analytics Syllabus</span>
                    </div>
                    ...
                    <p className="text-[16px] md:text-[18px] font-medium text-gray-600 leading-relaxed">
                        From GA4 fundamentals to advanced e-commerce and conversion tracking — all execution-focused with real data practice.
                    </p>
                </div>
