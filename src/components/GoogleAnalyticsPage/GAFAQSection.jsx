...
const faqs = [
    {
        q: "What is the Google Analytics course?",
        a: "The Google Analytics course is a certification program covering GA4 setup, campaign tracking, goal configuration, advanced segmentation, e-commerce tracking, and conversion reporting. It's designed to make you job-ready and Google-certified upon completion.",
    },
    {
        q: "What is Google Analytics 4 (GA4)?",
        a: "Google Analytics 4 is Google's latest analytics platform that tracks website and app data using an event-based model. It provides deeper insights into user behaviour, cross-platform journeys, and integrates natively with Google Ads for smarter remarketing.",
    },
    {
        q: "Who can enroll in this Google Analytics course?",
        a: "Our course is designed for a wide range of individuals including students, marketing professionals, business owners, web developers, and anyone looking to enhance their data and digital marketing skills with a focus on website analytics.",
    },
    {
        q: "Do I need any prior experience to join?",
        a: "No prior experience is required. We offer the course for beginners as well as advanced levels for those who already have some knowledge of digital marketing or website management.",
    },
    {
        q: "What tools will I learn during the course?",
        a: "You'll get hands-on experience with 20+ tools including Google Analytics 4, Google Tag Manager, Google Search Console, Looker Studio, and many more platforms used by top agencies and brands.",
    },
    {
    ...
    },
    {
        ...
        a: "You'll receive the Operating Media Google Analytics Certification plus preparation for the Google Analytics global certification exam — both highly regarded by top employers and digital agencies.",
    },
    {
    ...
    },
    {
        ...
        a: "Batches are limited to a maximum of 10 students to ensure personalized attention. The course fee is ₹9,000. Flexible EMI options are also available — speak to our counselors for details.",
    },
    {
...
export default function GAFAQSection() {
                ...
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
                        ...
                        <p className="font-medium text-[16px] md:text-[18px] text-gray-500 max-w-xl mx-auto leading-relaxed">
                            From admissions to placement — all your questions about the Google Analytics course answered in one place.
                        </p>
                    </motion.div>
                </div>
