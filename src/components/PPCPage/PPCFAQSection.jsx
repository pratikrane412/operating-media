...
const faqs = [
    {
        q: "What is the Pay Per Click (PPC) course?",
        a: "The PPC course is a certification program covering 65+ hours of training in Google Ads, YouTube Advertising, remarketing, display ads, and advanced SEM techniques. It's designed to make you job-ready and Google-certified upon completion.",
    },
    {
        q: "What is digital marketing?",
        a: "Digital marketing involves promoting products or services through digital channels such as search engines, social media, email, and websites. It includes strategies like SEO, content marketing, PPC advertising, social media marketing, and more.",
    },
    {
        q: "Who can enroll in this PPC course?",
        a: "Our course is designed for a wide range of individuals, including students, marketing professionals, business owners, and anyone looking to enhance their digital marketing skills with a focus on paid advertising.",
    },
    {
        q: "Do I need any prior experience to join?",
        a: "No prior experience is required. We offer courses for beginners as well as advanced levels for those who already have some knowledge of digital marketing.",
    },
    {
        q: "What tools will I learn during the PPC course?",
        a: "You'll get hands-on experience with 50+ tools including Google Ads Manager, Google Analytics, YouTube Studio, Google Tag Manager, SEMrush, and many more platforms used by top agencies.",
    },
    {
    ...
    },
    {
        ...
        a: "You'll receive the Operating Media PPC Certification plus preparation for the Google Ads global certification exam — both highly regarded by top employers and digital agencies.",
    },
    {
                ...
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
                        ...
                        <p className="font-medium text-[16px] md:text-[18px] text-gray-500 max-w-xl mx-auto leading-relaxed">
                            From admissions to placement — all your questions about the PPC course answered in one place.
                        </p>
                    </motion.div>
                </div>
