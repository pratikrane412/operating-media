                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                        ...
                        <div className="space-y-5 text-gray-600 text-[16px] md:text-[17px] font-medium leading-relaxed mb-8">
                            <p>
                                Our Pay Per Click training program is suited for individuals who are interested in gaining <span className="font-bold text-[#0f172a]">in-depth knowledge in paid search engine marketing</span>. This training course provides a detailed and practical approach to developing, structuring and managing a successful and cost-effective SEM advertising campaign.
                            </p>
                            <p>
                                Our PPC training Course mainly focuses on the top 3 search engines — <span className="font-bold text-[#0f172a]">Google, Yahoo and Bing (MSN)</span>. This program will cover all practical aspects of Google Adwords, targeting best practices for campaign structure, keyword selection, ad position preferences, and creative optimization.
                            </p>
                            <p>
                                Due to rising demand for Pay Per Click Marketers across the globe, skilled PPC specialists can afford the luxury to <span className="font-bold text-[#ECAB00]">choose and pick their jobs</span>. One can also use these skills to start their own entrepreneurial start-ups which are highly profitable.
                            </p>
                        </div>
