                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                        ...
                        <div className="space-y-5 text-gray-600 text-[16px] md:text-[17px] font-medium leading-relaxed mb-8">
                            <p>
                                WordPress is a free and open source content management system (CMS) built on PHP and MySQL. You can use WordPress to <span className="font-bold text-[#0f172a]">create your own website or blog without any programming knowledge</span>. It is used by over 15% of the top 1 million websites and is the most popular CMS in the world.
                            </p>
                            <p>
                                One of the primary attractions of WordPress is its <span className="font-bold text-[#0f172a]">user-friendly interface</span> — individuals with no coding background can create and manage professional websites with ease. The intuitive dashboard simplifies content creation, editing, media management, and user permissions with just a few clicks.
                            </p>
                            <p>
                                Our course covers everything from WordPress setup to advanced Elementor design, so you can <span className="font-bold text-[#ECAB00]">build high-converting landing pages and full websites</span> ready for real clients or your own business.
                            </p>
                        </div>
