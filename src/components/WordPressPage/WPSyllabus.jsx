...
import { CheckCircle2, ChevronDown, Download, Layout, Globe } from 'lucide-react';

const landingPageTopics = [
...
const modules = [
    {
        ...
        icon: <Layout size={20} />,
        desc: "Master the art of designing effective landing pages using the Elementor page builder plugin for WordPress, enhancing user engagement and conversions.",
        topics: landingPageTopics,
    },
    {
        id: "02",
        title: "Website Creation on WordPress",
        icon: <Globe size={20} />,
        desc: "Learn how to build professional websites using the WordPress platform, one of the most popular content management systems in the world.",
...
export default function WPSyllabus() {
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto">
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 border border-amber-100 mb-6">
                        ...
                        <span className="font-bold text-[11px] md:text-xs text-[#ECAB00] uppercase tracking-[0.2em]">WordPress Syllabus</span>
                    </div>
                    ...
                    <p className="text-[16px] md:text-[18px] font-medium text-gray-600 leading-relaxed">
                        From Elementor landing page design to full WordPress website creation — hands-on with real projects from day one.
                    </p>
                </div>
