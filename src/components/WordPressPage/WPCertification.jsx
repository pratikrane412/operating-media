...
const certFeatures = [
    {
        ...
        desc: "Receive an industry-recognised diploma certificate upon successful completion of the WordPress Development course.",
    },
    {
        icon: <ShieldCheck size={22} />,
        title: "WordPress Certification",
        desc: "Get fully prepared for and supported through the official WordPress certification exam alongside your WordPress training.",
    },
    {
