...
const faqs = [
    {
        q: "What is the Social Media Optimization (SMO) course?",
        a: "The SMO course is a comprehensive certification program covering both organic social media marketing and paid advertising across Instagram, Facebook, LinkedIn, Twitter, and YouTube. It covers everything from building brand pages and growing followers to running advanced paid campaigns with pixel tracking and detailed reporting.",
    },
    {
        q: "What is Social Media Optimization?",
        a: "Social Media Optimization (SMO) is the process of increasing brand awareness, driving website traffic, and engaging audiences through social media platforms — both organically through content and community building, and through paid advertising strategies.",
    },
    {
        q: "Which platforms are covered in this course?",
        a: "The course covers Instagram, Facebook, LinkedIn, Twitter, Pinterest, and YouTube — both for organic growth strategies and paid advertising campaigns, giving you a complete command of all major social platforms.",
    },
    {
        q: "Who can enroll in this SMO course?",
        a: "The course is designed for students, marketing professionals, business owners, freelancers, and entrepreneurs who want to build a strong social media presence and run effective paid campaigns for themselves or their clients.",
    },
    {
        q: "Do I need any prior experience to join?",
        a: "No prior experience is required. We start from the basics of understanding social media platforms and progressively move into advanced targeting, campaign optimization, and analytics.",
    },
    {
        q: "What tools will I learn during the SMO course?",
        a: "You'll get hands-on experience with 50+ tools including Meta Ads Manager, LinkedIn Campaign Manager, Twitter Ads, YouTube Studio, Meta Pixel, Google Analytics, and many more platforms used by top agencies and brands.",
    },
    {
    ...
    },
    {
        ...
        a: "You'll receive the Operating Media Social Media Marketing Diploma Certificate upon completion, along with preparation support for the Google certification exam — both recognised by top employers and digital agencies.",
    },
    {
    ...
    },
    {
        ...
        a: "Batches are limited to a maximum of 10 students to ensure personalised attention. The course fee is ₹12,000. Flexible EMI options are also available — speak to our counselors for details.",
    },
];

export default function SMOFAQSection() {
                ...
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
                        ...
                        <p className="font-medium text-[16px] md:text-[18px] text-gray-500 max-w-xl mx-auto leading-relaxed">
                            From admissions to placement — all your questions about the SMO course answered in one place.
                        </p>
                    </motion.div>
                </div>
