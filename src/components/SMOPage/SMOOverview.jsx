...
export default function SMOOverview() {
    return (
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                        ...
                        <div className="space-y-5 text-gray-600 text-[16px] md:text-[17px] font-medium leading-relaxed mb-8">
                            <p>
                                The world is going global and social platforms like Facebook, Instagram and LinkedIn have fundamentally <span className="font-bold text-[#0f172a]">changed the way people communicate and interact</span>. Social Media Marketing gives businesses a powerful advantage to connect with their customers in a meaningful and measurable way.
                            </p>
                            <p>
                                For every brand today, <span className="font-bold text-[#0f172a]">visibility across popular social networks is no longer optional</span> — it's the need of the hour. This has given birth to the fast-growing field of social media marketing and optimization, where skilled professionals are in high demand across every industry.
                            </p>
                            <p>
                                To become a true SMO professional, you need training designed with <span className="font-bold text-[#ECAB00]">every aspect of social media in mind</span> — organic growth strategies, paid advertising, content creation, and deep campaign analytics across all major platforms.
                            </p>
                        </div>
