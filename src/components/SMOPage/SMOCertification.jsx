...
const certFeatures = [
    {
        ...
        desc: "Receive an industry-recognised diploma certificate upon successful completion of the Social Media Optimization course.",
    },
    {
        icon: <ShieldCheck size={22} />,
        title: "Social Media Marketing Certification",
        desc: "Get fully prepared for and supported through the official Social Media certification exam alongside your SMO training.",
    },
    {
...
export default function SMOCertification() {
    return (
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row gap-3 shrink-0">
                        <div className="flex items-center gap-4 bg-white/10 rounded-xl px-5 py-4 border border-white/10">
                            ...
                            <div>
                                <p className="font-black text-white text-[15px] leading-tight">Diploma Certified</p>
