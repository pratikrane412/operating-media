                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                        ...
                        <div className="space-y-5 text-gray-600 text-[16px] md:text-[17px] font-medium leading-relaxed mb-8">
                            <p>
                                Our SEO training programs are designed by <span className="font-bold text-[#0f172a]">renowned SEO professionals</span> who teach you the most effective techniques to improve rankings, increase organic traffic, and drive real sales performance for any website.
                            </p>
                            <p>
                                Our training is guaranteed to make you feel confident about your SEO skills with <span className="font-bold text-[#0f172a]">actual hands-on experience</span> across real SEO activities. Every program is designed to be participative, interesting, and practical — not just theory.
                            </p>
                            <p>
                                The course includes in-depth knowledge of SEO strategies, tips and tricks — covering everything from <span className="font-bold text-[#ECAB00]">website structure and keyword research</span> to meta data, on-page optimization, off-page link building, and full site audits.
                            </p>
                        </div>
