...
const modules = [
    {
        ...
        icon: <Search size={20} />,
        desc: "Gain expertise in optimizing websites to rank higher in search engine results pages (SERPs) and drive consistent organic traffic for any business or brand.",
        topics: seoTopics,
    },
];
...
export default function SEOSyllabus() {
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto">
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 border border-amber-100 mb-6">
                        ...
                        <span className="font-bold text-[11px] md:text-xs text-[#ECAB00] uppercase tracking-[0.2em]">SEO Syllabus</span>
                    </div>
                    ...
                    <p className="text-[16px] md:text-[18px] font-medium text-gray-600 leading-relaxed">
                        From SEO fundamentals and keyword research to advanced audits, backlink strategies, and Search Console mastery — all execution-focused with real websites.
                    </p>
                </div>
