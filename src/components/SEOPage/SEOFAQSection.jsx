...
const faqs = [
    {
        q: "What is the SEO course at Operating Media?",
        a: "Our SEO certification course is a hands-on training program covering everything from SEO fundamentals and keyword research to on-page optimization, off-page link building, technical audits, and Google Search Console — all taught by practising SEO professionals with real-world campaign experience.",
    },
    {
        q: "What is Search Engine Optimization (SEO)?",
        a: "SEO is the process of optimizing a website to rank higher in search engine results pages (SERPs) like Google, driving consistent organic traffic without paying for ads. It involves keyword research, content strategy, technical improvements, and link building.",
    },
    {
        q: "Who can enroll in this SEO course?",
        a: "The course is designed for students, marketing professionals, freelancers, business owners, content writers, and web developers who want to improve website rankings and drive organic traffic — no prior technical knowledge is required.",
    },
    {
        q: "Do I need any prior experience to join?",
        a: "No prior experience is needed. We start from the basics — what SEO is and how it works — and progressively move into advanced optimization techniques, tools, and live audits.",
    },
    {
        q: "What tools will I learn during the SEO course?",
        a: "You'll get hands-on practice with 20+ industry tools including Google Search Console, Google Analytics, SEMrush, Ahrefs, Screaming Frog, Google Webmaster Tools, Moz, Ubersuggest, and many more used by top agencies.",
    },
    {
        q: "What is covered in the on-page and off-page SEO modules?",
        a: "On-page SEO covers meta tags, heading structure, keyword placement, content optimization, internal linking, and site speed. Off-page SEO covers backlink building strategies, SEO submissions, domain authority, and competitor link analysis.",
    },
    {
    ...
    },
    {
        ...
        a: "You'll receive the Operating Media SEO Certification upon completion, along with full preparation support for the Google certification exam — both recognised by top employers and digital agencies across India.",
    },
    {
        q: "Is placement assistance provided?",
        a: "Yes — 100% placement assistance including resume building, interview preparation, and referrals to 250+ hiring partners across agencies and brands.",
    },
    {
        q: "What is the batch size and fee?",
        a: "Batches are capped at a maximum of 10 students to ensure personalised attention. The course fee is ₹9,000. Flexible EMI options are also available — speak to our counselors for details.",
    },
];
                ...
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
                        ...
                        <p className="font-medium text-[16px] md:text-[18px] text-gray-500 max-w-xl mx-auto leading-relaxed">
                            From admissions to placement — all your questions about the SEO course answered in one place.
                        </p>
                    </motion.div>
                </div>
