...
const faqs = [
    {
        q: "What is the Advanced Diploma in Digital Marketing?",
        a: "The Advanced Diploma is a 4-month fast-track program covering 25+ modules including Google Ads, Social Media Advertising, SEO, Email Marketing, AI Automation, and more. It's designed for immediate job-readiness with hands-on execution from day one.",
    },
    {
        q: "Who should enroll in the Advanced Diploma?",
        a: "It's perfect for three types of learners: business owners who want to stop outsourcing their marketing, working professionals looking to switch careers quickly without quitting their current job, and students who want a job immediately after graduation.",
    },
    {
        q: "Do I need any prior experience to join?",
        a: "No prior experience is required. The program starts from digital marketing basics and quickly progresses to advanced tools and live campaigns. Beginners are welcome.",
    },
    {
    ...
    },
    {
        ...
        a: "You'll get hands-on with 70+ premium tools including Google Ads, Meta Ads Manager, Google Analytics 4, SEMrush, Canva, Mailchimp, HubSpot, Zapier, WordPress, Elementor, and many more AI-powered platforms.",
    },
    {
        q: "Are the courses available on weekends?",
        a: "Yes — we offer both weekday and weekend batches at our Andheri and Borivali campuses, making it easy for working professionals to attend without disrupting their current job.",
    },
    {
        q: "What certification will I receive?",
        a: "Upon completion you will receive the Operating Media Advanced Diploma Certification plus preparation and support for Google Ads and Meta Blueprint global certifications — all highly regarded by top employers.",
    },
    {
        q: "Do you offer job placement assistance?",
        a: "Yes — 100% placement assistance through resume building, mock interviews, LinkedIn optimization, and direct connections to our 250+ hiring partner network across agencies and brands.",
    },
    {
        q: "What is the batch size?",
        a: "We keep batches to a maximum of 12 students to ensure personalized attention, real practice sessions, and a genuine agency-style learning environment.",
    },
    {
        q: "Are there any EMI options available?",
        a: "Yes — we offer flexible 0% EMI payment options to make the program accessible to everyone. Speak to our counselors for a customized payment plan that suits your budget.",
    },
    {
    ...
    },
    {
        ...
        a: "Yes — all students get access to our LMS (Learning Management System) with course notes, batch schedules, attendance tracking, resource libraries, and a student forum for peer collaboration.",
    },
];
                ...
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
                        ...
                        <p className="font-medium text-[16px] md:text-[18px] text-gray-500 max-w-xl mx-auto leading-relaxed">
                            From admissions to placement — all your questions about the Advanced Diploma answered in one place.
                        </p>
                    </motion.div>
                </div>
