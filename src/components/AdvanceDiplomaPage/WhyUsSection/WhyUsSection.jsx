...
const FEATURES = [
    ...
    {
        Icon: Wrench,
        title: 'Master 70+ Essential Tools',
        desc: 'Hands-on premium access to the world\'s top SEO, Analytics, and AI platforms — not just theory.',
    },
    {
        Icon: TrendingUp,
    ...
    },
    {
        ...
        desc: 'Dedicated career support, interview prep, and direct referrals to 250+ hiring partners.',
    },
    {
        Icon: Zap,
        title: 'Small Personalized Batches',
        desc: 'Maximum 12 students per batch ensures focused, one-on-one attention from expert trainers.',
    },
    {
        Icon: CreditCard,
        title: 'Flexible 0% EMI Options',
        desc: 'Start your digital career without financial stress. Cover-up sessions for any missed lectures included.',
    },
];
                ...
                <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
                    <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
                        ...
                        <p className="text-[16px] md:text-[18px] font-medium text-gray-600 leading-relaxed max-w-2xl mx-auto">
                            Strip away the theory. The Advanced Diploma is built purely around the tools, channels and strategies that generate revenue.
                        </p>
                    </motion.div>
                </div>
                ...
                >
                    ...
                    <div className="relative z-10 text-center lg:text-left max-w-xl">
                        ...
                        <p className="font-medium text-gray-400 text-[16px] md:text-[18px] leading-relaxed">
                            Download our 2026 Advanced Diploma Syllabus for a detailed breakdown of all 25 modules, projects, and 70+ tools.
                        </p>
                    </div>
